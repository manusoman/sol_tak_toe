...
const programId = new solanaWeb3.PublicKey("2K1zeh9cEbPc5koURBGpX5hA44FGBXMvRPZ93gwtTQCZ");
...
export async function signUpPlayer(playerId, name) {
    ...
    const sg = await signAndSend(tx, playerId);
    return connection.confirmTransaction(sg, 'finalized');
}
